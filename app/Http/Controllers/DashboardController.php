...
class DashboardController extends Controller
{
    ...
    public function getBookingCurrentByDoctor(){
        ...
        ->select('number_bookings.*','appointments.patient_name','appointments.phone_number','re_examination.date_of_examination', DB::raw("concat(doctors.first_name,' ',doctors.last_name) as doctor_name"))
